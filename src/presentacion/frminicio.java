...
public class frminicio extends javax.swing.JFrame {
    ...
    public frminicio() {
        ...
        this.setTitle("SISTEMA DE RESERVA DE HABITACIONES Y GESTION DE VENTAS--HOTEL EL CONDOR");
    }
    ...
    private void initComponents() {
        ...
        lblapellidos.setBounds(30, 100, 140, 14);
        ...
        lblacceso.setBounds(30, 130, 140, 14);
        escritorio.add(lblacceso, javax.swing.JLayeredPane.DEFAULT_LAYER);

        mnusisreserva.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/home78.png"))); // NOI18N
        mnusisreserva.setMnemonic('f');
        mnusisreserva.setText("Sisreserva");
        menuBar.add(mnusisreserva);

        mnuarchivo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/file98.png"))); // NOI18N
        mnuarchivo.setMnemonic('e');
        mnuarchivo.setText("Archivo");
        mnuarchivo.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentMoved(java.awt.event.ComponentEvent evt) {
                mnuarchivoComponentMoved(evt);
            }
        });
        ...
        cutMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/briefcase69.png"))); // NOI18N
        ...
        copyMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/logotype111.png"))); // NOI18N
        ...
        mnureservas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/book312.png"))); // NOI18N
        ...
        contentMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/circular210.png"))); // NOI18N
        ...
        aboutMenuItem.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/workers.png"))); // NOI18N
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/payment7.png"))); // NOI18N
        jMenuItem1.setText("Pagos");
        mnureservas.add(jMenuItem1);

        menuBar.add(mnureservas);

        mnuconsultas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/search-engine-optimization.png"))); // NOI18N
        mnuconsultas.setText("Consultas");
        menuBar.add(mnuconsultas);

        mnuconfiguraciones.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/gears6.png"))); // NOI18N
        mnuconfiguraciones.setText("Configuraciones");

        jMenuItem2.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_U, java.awt.event.InputEvent.CTRL_MASK));
        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/businessman287.png"))); // NOI18N
        ...
        mnuherramientas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/settings46.png"))); // NOI18N
        mnuherramientas.setText("Herramientas");
        menuBar.add(mnuherramientas);

        mnuayuda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/help18.png"))); // NOI18N
        mnuayuda.setText("Ayudas");
        ...
        mnusalir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/files/exit7.png"))); // NOI18N
...
// TODO add your handling code here:
    ...
    private void mnuarchivoComponentMoved(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_mnuarchivoComponentMoved
        // TODO add your handling code here:
    }//GEN-LAST:event_mnuarchivoComponentMoved
    ...
    private void contentMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_contentMenuItemActionPerformed
        ...
        frmreserva.txttrabajador.setText(lblnombre.getText()+ " " + lblapellidos.getText());
